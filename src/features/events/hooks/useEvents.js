    ...
    const transformEventForDisplay = useCallback((event, includeParticipation = false) => {
        ...
        return {
            ...
            canSubscribe: userCanRegister && 
                ...
                isFutureEvent(event.startDateTime),
            currentParticipants: (Number.isInteger(realParticipantsCount) ? realParticipantsCount : null) ?? (event.currentParticipants || 0),
            participationStatus
        };
    ...
    const transformSingleEventForDisplay = useCallback((eventData) => {
        ...
        return {
            ...
            canSubscribe: userCanRegister && 
                ...
                isFutureEvent(eventData.startDateTime),
            currentParticipants: (Number.isInteger(realParticipantsCount) ? realParticipantsCount : null) ?? (eventData.currentParticipants || 0),
            participationStatus
        };
